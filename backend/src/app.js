...
const { publicRouter: iletisimPublic, adminRouter: iletisimAdmin } = require("./routes/iletisim.routes");
...
const { publicRouter: haritaPublic } = require("./routes/harita.routes");
...
publicApi.use("/iletisim", iletisimPublic);
...
publicApi.use("/harita", haritaPublic);
...
adminApi.use("/iletisim", iletisimAdmin);
